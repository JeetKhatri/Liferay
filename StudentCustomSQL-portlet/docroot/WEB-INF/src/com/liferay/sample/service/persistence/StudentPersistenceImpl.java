...
import com.liferay.sample.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	 ...
	 */
	@Override
	public Student create(int sid) {
		Student student = new StudentImpl();

		student.setNew(true);
		student.setPrimaryKey(sid);
	...
	@Override
	public Student updateImpl(com.liferay.sample.model.Student student)
	...
	protected Student toUnwrappedModel(Student student) {
		...
		studentImpl.setSid(student.getSid());
		studentImpl.setSname(student.getSname());
		studentImpl.setSgender(student.getSgender());
		studentImpl.setSnumber(student.getSnumber());
	 ...
	 */
	@Override
	public Student findByPrimaryKey(int sid)
		throws NoSuchStudentException, SystemException {
	 ...
	 */
	@Override
	public Student fetchByPrimaryKey(int sid) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.sample.model.Student")));
