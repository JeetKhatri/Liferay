...
/**
 * Provides the local service interface for StudentAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author admin
 * @see StudentAddressLocalServiceUtil
...
public interface StudentAddressLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentAddressLocalServiceUtil} to access the student address local service. Add custom service methods to {@link com.liferay.sample.service.impl.StudentAddressLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
